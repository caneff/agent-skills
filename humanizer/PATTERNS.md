...
The 33 patterns `SKILL.md` scans for, grouped by category, each with a
before/after example. Read this file when doing the actual pass — `SKILL.md`
only needs to point here.
