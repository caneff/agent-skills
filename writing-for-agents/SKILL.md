...
description: >-
  Write and revise instructions for coding agents, including skills and AGENTS.md or CLAUDE.md. Use when the user says "make a skill", "edit a SKILL.md", "global Claude setup", "global Claude stuff", or asks what to add to an agent-instruction file.
---
