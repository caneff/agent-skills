...
or agent — can follow. The output is a `CODING_STANDARDS.md` that `/two-axis-code-review`
...
Choose the target so the output slots into what `/two-axis-code-review` already reads:
